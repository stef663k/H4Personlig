.include "ProjectDefines.inc"  ; Include the defines file

.cseg

/********************************************************************************************************
  Funktionsnavn    : SetupTimer0OverflowInterrupt
  Beskrivelse      : Sætter Timer 0 Overflow interrupt op og konfigurerer pins. 
  Input            : Ingen
  Output           : Ingen
...
/********************************************************************************************************
  ...
  Beskrivelse      : Enable Timer 0 Overflow interrupt. 
  Input            : Ingen.
  Output           : Ingen
  Registre anvendt : R17
  Kalder           : Ingen
...
TIMER0_OVERFLOW_INTERRUPT:
    ...
    ldi     r17, RedLedBitValue                 ; R17 = værdien af konstant RedLedBitValue
